...
const ART_HOW_TO_GET_MORE_VIEWS_YOUTUBE_2026_ES: BlockType[] = [
  ...
  { type: 'p', t: 'Un dato importante: canales con menos de 10.000 suscriptores que mantienen un tiempo de retención superior al 50% pueden superar en recomendaciones a canales con millones de seguidores. El tamaño del canal importa mucho menos de lo que crees. Lo que importa es la calidad de la señal que le das al algoritmo.' },
  ...
  { type: 'p', t: 'El CTR medio en YouTube está entre el 2% y el 10%. Si el tuyo está por debajo del 4%, tu miniatura o tu título están fallando. La miniatura es lo primero que ve un espectador potencial, y tienes menos de un segundo para captar su atención. No exageres, pero sí despierta la curiosidad.' },
  ...
  { type: 'p', t: 'Un estudio de canales que analizamos en YTubViral mostró que los canales que publicaron de forma constante durante 6 meses (sin saltarse semanas) crecieron un 3,4 veces más rápido que los que publicaban de forma irregular, incluso cuando la frecuencia semanal era la misma. La constancia manda.' },
  ...
  { type: 'p', t: 'Un caso real: el canal de educación financiera \'Finanzas Para Todos\' pasó de 12.000 a 87.000 suscriptores en 4 meses simplemente adaptando sus mejores momentos en Shorts y añadiendo una llamada a la acción al final de cada uno. No necesitas crear contenido doble, solo reutilizar lo que ya tienes de forma inteligente.' },
...
const ART_HOW_TO_GET_MORE_VIEWS_YOUTUBE_2026_EN: BlockType[] = [
  ...
  { type: 'p', t: 'One channel we looked at in the finance niche changed a single title from \'Investing Tips for Beginners\' to \'I Lost $12,000 Investing — Here\'s What Beginners Must Know\' and saw CTR jump from 2.8% to 7.1% on the same thumbnail. The video topic didn\'t change. The framing did.' },
  ...
  { type: 'p', t: 'The key is to make Shorts that create a cliffhanger or demonstrate value, then include a clear verbal or on-screen call to action pointing to the full video. A channel in the personal finance space reported gaining an extra 180,000 views per month on their long-form content purely from Shorts funnel traffic within 90 days of implementing this strategy consistently.' },
...
const ART_YOUTUBE_THUMBNAIL_TIPS_BEGINNERS_GUIDE_ES: BlockType[] = [
  ...
  { type: 'p', t: 'El CTR, o tasa de clics, es una de las métricas más importantes de YouTube. Canales con un CTR superior al 6% crecen considerablemente más rápido que los que están por debajo del 3%. La diferencia muchas veces está en la miniatura, no en el algoritmo ni en la suerte.' },
  ...
  { type: 'p', t: 'Canales grandes como Veritasium o Marques Brownlee han hablado públicamente de cómo prueban múltiples versiones de miniaturas antes de quedarse con la definitiva. No es perfeccionismo, es optimización basada en datos. Un cambio de miniatura puede aumentar el CTR de un video de un 3% a un 7%, lo que se traduce directamente en más vistas y más crecimiento.' },
...
const ART_YOUTUBE_THUMBNAIL_TIPS_BEGINNERS_GUIDE_EN: BlockType[] = [
  { type: 'p', t: 'If you have ever uploaded a video and watched it get zero clicks, there is a good chance your thumbnail was the problem. Most beginners spend hours scripting, filming, and editing, then spend about three minutes slapping a thumbnail together. That is backwards. Studies show that 90% of the best-performing YouTube videos have custom thumbnails, and YouTube itself has stated that thumbnails are one of the most important factors viewers use when deciding what to watch. If you are just starting out, these youtube thumbnail tips for beginners will help you stop losing clicks and start building an audience that actually grows.' },
  ...
  { type: 'p', t: 'Almost every high-performing thumbnail breaks down into three core elements. Get these right and you are already ahead of 80% of beginners.' },
  ...
  { type: 'p', t: 'YouTube thumbnails are often viewed at the size of a postage stamp on mobile devices, which is where over 70% of YouTube viewing happens. Any text you put in your thumbnail needs to be readable at that tiny size. That means three to five words maximum, using a bold font, and making the text large enough to be legible even when the thumbnail is shrunk down. Avoid full sentences. Think headlines, not descriptions.' },
