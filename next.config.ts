    ...
    return [
      // Security headers — all routes
      {
        ...
        headers: [
          ...
          { key: 'Content-Security-Policy', value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' 'wasm-unsafe-eval' blob: https://js.stripe.com https://vercel.live; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: blob: https: http:; connect-src 'self' blob: https://api.stripe.com https://*.vercel.live https://*.anthropic.com https://staticimgly.com https://*.staticimgly.com https://*.huggingface.co https://huggingface.co wss:; worker-src 'self' blob:; frame-src https://js.stripe.com https://vercel.live https://www.youtube.com https://www.youtube-nocookie.com; object-src 'none'; base-uri 'self'" },
