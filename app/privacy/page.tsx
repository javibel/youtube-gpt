      ...
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-10">
        ...
        {[
          ...
          },
          {
            ...
            body: t(
              'Algunos de nuestros proveedores (Anthropic, Vercel, Stripe, Resend, Ideogram, Cloudflare) pueden tratar datos fuera del Espacio Económico Europeo, principalmente en Estados Unidos. En estos casos, dichas transferencias se realizan con garantías adecuadas conforme al RGPD, incluyendo el Marco de Privacidad de Datos UE-EE.UU. (EU-US Data Privacy Framework) y/o Cláusulas Contractuales Tipo cuando aplique.',
              'Some of our providers (Anthropic, Vercel, Stripe, Resend, Ideogram, Cloudflare) may process data outside the European Economic Area, primarily in the United States. In such cases, transfers are carried out with adequate safeguards in accordance with the GDPR, including the EU-US Data Privacy Framework and/or Standard Contractual Clauses where applicable.'
            ),
          },
          {
