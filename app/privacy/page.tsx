        ...
        {[
          {
            ...
            body: t(
              'El responsable del tratamiento de los datos personales recogidos a través de YTubViral es Javier Jimeno Plata, con domicilio en Madrid, España. Email de contacto: hello@ytubviral.com.',
              'The controller of personal data collected through YTubViral is Javier Jimeno Plata, based in Madrid, Spain. Contact email: hello@ytubviral.com.'
            ),
          },
          {
          ...
          },
          {
            ...
            body: t(
              'Conservamos tus datos mientras tu cuenta esté activa. Los datos de rate limiting (IPs) se eliminan automáticamente tras 24 horas. Si eliminas tu cuenta, tus datos personales, historial de generaciones y tokens de YouTube serán eliminados en un plazo máximo de 30 días, salvo obligación legal de conservación.',
              'We retain your data for as long as your account is active. Rate limiting data (IPs) is automatically deleted after 24 hours. If you delete your account, your personal data, generation history and YouTube tokens will be deleted within a maximum of 30 days, unless legally required to retain it.'
            ),
          },
          {
