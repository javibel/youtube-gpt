    ...
    <div className="min-h-screen grain" style={{ background: 'var(--ink)', color: 'var(--text)' }}>
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-10">
        ...
        <div>
          ...
          <p className="text-zinc-500 text-sm mt-2 font-mono-jb">{t('Última actualización: junio de 2026', 'Last updated: June 2026')}</p>
        </div>
        ...
        {[
          ...
          },
          {
            ...
            body: t(
              'YTubViral proporciona acceso a herramientas de creación y análisis de contenido para YouTube, incluyendo: generador de títulos virales, scripts con IA, SEO score, keyword research, análisis de competidores, estimador de ingresos, A/B testing de títulos, mejor hora para publicar, calendario de contenido, análisis de retención, predictor de vídeos, AI coach, explorador de tendencias y centro de aprendizaje. El contenido se genera mediante modelos de inteligencia artificial de terceros (Anthropic Claude). También se ofrece una extensión de Chrome complementaria que permite acceder a algunas funcionalidades directamente desde YouTube. Los resultados generados por IA son orientativos y no constituyen asesoramiento profesional.',
              'YTubViral provides access to content creation and analysis tools for YouTube, including: viral title generator, AI scripts, SEO score, keyword research, competitor analysis, revenue estimator, title A/B testing, best time to post, content calendar, retention analysis, video predictor, AI coach, trend explorer and learning hub. Content is generated using third-party artificial intelligence models (Anthropic Claude). A companion Chrome extension is also offered, allowing access to some features directly from YouTube. AI-generated results are indicative and do not constitute professional advice.'
            ),
          },
          {
