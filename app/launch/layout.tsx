...
export const metadata: Metadata = {
  ...
  description:
    '14 AI tools to grow on YouTube. Join the waitlist and get 50% off for life. Launching on Product Hunt soon.',
  alternates: { canonical: 'https://ytubviral.com/launch' },
  openGraph: {
    title: 'YTubViral — 14 AI Tools to Grow on YouTube',
    description: 'Join the waitlist and get 50% off for life. Launching on Product Hunt soon.',
  ...
  twitter: {
    ...
    title: 'YTubViral — 14 AI Tools to Grow on YouTube',
    description: 'Join the waitlist and get 50% off for life.',
