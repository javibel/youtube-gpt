...
const COPY = {
  es: {
    ...
    sub: 'Apúntate a la lista de espera y consigue 50% de descuento de por vida cuando lancemos.',
    ...
    reasons: [
      ['50% de por vida', 'Los primeros en la lista se quedan con el mejor precio para siempre.'],
  ...
  en: {
    ...
    sub: 'Join the waitlist and get 50% off for life when we launch.',
    ...
    why: 'Why join?',
    reasons: [
      ['50% off for life', 'Early supporters lock in the best price forever.'],
