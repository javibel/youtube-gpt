        ...
        <div className="yv-page" style={{ paddingTop: 0 }}>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
            ...
            >
              ...
              <option value="likes" style={{ background: 'var(--yv-bg-3)', color: 'var(--yv-text-1)' }}>Likes</option>
              <option value="engagement" style={{ background: 'var(--yv-bg-3)', color: 'var(--yv-text-1)' }}>Engagement %</option>
            </select>
            ...
            >
              ...
              <option value="medium" style={{ background: 'var(--yv-bg-3)', color: 'var(--yv-text-1)' }}>{t('Medio (4-20 min)', 'Medium (4-20 min)')}</option>
              <option value="long" style={{ background: 'var(--yv-bg-3)', color: 'var(--yv-text-1)' }}>{t('Largo (> 20 min)', 'Long (> 20 min)')}</option>
            </select>
            ...
            >
              ...
              <option value="10000" style={{ background: 'var(--yv-bg-3)', color: 'var(--yv-text-1)' }}>10K+ likes</option>
              <option value="100000" style={{ background: 'var(--yv-bg-3)', color: 'var(--yv-text-1)' }}>100K+ likes</option>
            </select>
            ...
            >
              ...
              <option value="en" style={{ background: 'var(--yv-bg-3)', color: 'var(--yv-text-1)' }}>{t('Inglés', 'English')}</option>
              <option value="pt" style={{ background: 'var(--yv-bg-3)', color: 'var(--yv-text-1)' }}>{t('Portugués', 'Portuguese')}</option>
              <option value="fr" style={{ background: 'var(--yv-bg-3)', color: 'var(--yv-text-1)' }}>{t('Francés', 'French')}</option>
              <option value="de" style={{ background: 'var(--yv-bg-3)', color: 'var(--yv-text-1)' }}>{t('Alemán', 'German')}</option>
              <option value="ja" style={{ background: 'var(--yv-bg-3)', color: 'var(--yv-text-1)' }}>{t('Japonés', 'Japanese')}</option>
              <option value="ko" style={{ background: 'var(--yv-bg-3)', color: 'var(--yv-text-1)' }}>{t('Coreano', 'Korean')}</option>
              <option value="hi" style={{ background: 'var(--yv-bg-3)', color: 'var(--yv-text-1)' }}>Hindi</option>
            </select>
